...
from queries.balance_queries import balance_queries
from prompts.balance_prompts import balance_prompts
    ...
    def _get_empresa_info_cached(empresa_rut):
        ...
        try:
            connection = pymysql.connect(
                ...
                read_timeout=10,     # Timeout más corto
                autocommit=True      # Evitar transacciones innecesarias
            )

            with connection.cursor(pymysql.cursors.DictCursor) as cursor:
                cursor.execute("""
                    SELECT empresa, base_datos, correo, grupo, quien_registra
                    FROM empresas
                ...
                if empresa_info:
                    ...
                    print(f" Info de empresa cacheada: {empresa_rut}")
        ...
        try:
            ...
            if cuentas_proveedores_honorarios or cuentas_anticipos:
                ...
                if cuentas_significativas:
                    ...
                    try:
                        from services.proveedores_service import proveedores_service
